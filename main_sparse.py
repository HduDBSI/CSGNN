...
def main():
    # 选择不同过滤规则的数据集
    train_data = pickle.load(open('./datasets/' + opt.dataset + '/filter20/train.txt', 'rb'))
    test_data = pickle.load(open('./datasets/' + opt.dataset + '/filter20/test.txt', 'rb'))
    train_cate = pickle.load(open('./datasets/' + opt.dataset + '/filter20/category_train.txt', 'rb'))
    test_cate = pickle.load(open('./datasets/' + opt.dataset + '/filter20/category_test.txt', 'rb'))
